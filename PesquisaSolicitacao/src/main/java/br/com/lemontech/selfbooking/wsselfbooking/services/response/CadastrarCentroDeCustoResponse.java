/**
 * CadastrarCentroDeCustoResponse.java
 *
...
public class CadastrarCentroDeCustoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public CadastrarCentroDeCustoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this CadastrarCentroDeCustoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this CadastrarCentroDeCustoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CadastrarCentroDeCustoResponse)) return false;
        CadastrarCentroDeCustoResponse other = (CadastrarCentroDeCustoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CadastrarCentroDeCustoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "cadastrarCentroDeCustoResponse"));
