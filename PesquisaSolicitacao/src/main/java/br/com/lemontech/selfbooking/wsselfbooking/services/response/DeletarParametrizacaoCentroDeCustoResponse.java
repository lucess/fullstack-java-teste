/**
 * DeletarParametrizacaoCentroDeCustoResponse.java
 *
...
public class DeletarParametrizacaoCentroDeCustoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public DeletarParametrizacaoCentroDeCustoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this DeletarParametrizacaoCentroDeCustoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this DeletarParametrizacaoCentroDeCustoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DeletarParametrizacaoCentroDeCustoResponse)) return false;
        DeletarParametrizacaoCentroDeCustoResponse other = (DeletarParametrizacaoCentroDeCustoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DeletarParametrizacaoCentroDeCustoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "deletarParametrizacaoCentroDeCustoResponse"));
