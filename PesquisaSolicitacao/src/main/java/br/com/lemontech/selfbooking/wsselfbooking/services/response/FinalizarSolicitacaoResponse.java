/**
 * FinalizarSolicitacaoResponse.java
 *
...
public class FinalizarSolicitacaoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public FinalizarSolicitacaoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this FinalizarSolicitacaoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this FinalizarSolicitacaoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FinalizarSolicitacaoResponse)) return false;
        FinalizarSolicitacaoResponse other = (FinalizarSolicitacaoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FinalizarSolicitacaoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "finalizarSolicitacaoResponse"));
