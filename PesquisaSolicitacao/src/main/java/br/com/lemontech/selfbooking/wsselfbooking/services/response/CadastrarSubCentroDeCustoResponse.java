/**
 * CadastrarSubCentroDeCustoResponse.java
 *
...
public class CadastrarSubCentroDeCustoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public CadastrarSubCentroDeCustoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this CadastrarSubCentroDeCustoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this CadastrarSubCentroDeCustoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CadastrarSubCentroDeCustoResponse)) return false;
        CadastrarSubCentroDeCustoResponse other = (CadastrarSubCentroDeCustoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CadastrarSubCentroDeCustoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "cadastrarSubCentroDeCustoResponse"));
