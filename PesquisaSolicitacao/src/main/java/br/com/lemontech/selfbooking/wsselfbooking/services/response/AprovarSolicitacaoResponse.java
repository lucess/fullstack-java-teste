/**
 * AprovarSolicitacaoResponse.java
 *
...
public class AprovarSolicitacaoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public AprovarSolicitacaoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this AprovarSolicitacaoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this AprovarSolicitacaoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AprovarSolicitacaoResponse)) return false;
        AprovarSolicitacaoResponse other = (AprovarSolicitacaoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AprovarSolicitacaoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "aprovarSolicitacaoResponse"));
