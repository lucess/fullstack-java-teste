/**
 * AlterarStatusTarifarioResponse.java
 *
...
public class AlterarStatusTarifarioResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public AlterarStatusTarifarioResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this AlterarStatusTarifarioResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this AlterarStatusTarifarioResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AlterarStatusTarifarioResponse)) return false;
        AlterarStatusTarifarioResponse other = (AlterarStatusTarifarioResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AlterarStatusTarifarioResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "alterarStatusTarifarioResponse"));
