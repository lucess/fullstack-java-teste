/**
 * AlterarStatusFuncionarioResponse.java
 *
...
public class AlterarStatusFuncionarioResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public AlterarStatusFuncionarioResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this AlterarStatusFuncionarioResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this AlterarStatusFuncionarioResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AlterarStatusFuncionarioResponse)) return false;
        AlterarStatusFuncionarioResponse other = (AlterarStatusFuncionarioResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AlterarStatusFuncionarioResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "alterarStatusFuncionarioResponse"));
