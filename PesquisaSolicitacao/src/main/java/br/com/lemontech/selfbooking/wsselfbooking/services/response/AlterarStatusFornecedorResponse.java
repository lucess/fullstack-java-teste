/**
 * AlterarStatusFornecedorResponse.java
 *
...
public class AlterarStatusFornecedorResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public AlterarStatusFornecedorResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this AlterarStatusFornecedorResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this AlterarStatusFornecedorResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AlterarStatusFornecedorResponse)) return false;
        AlterarStatusFornecedorResponse other = (AlterarStatusFornecedorResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AlterarStatusFornecedorResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "alterarStatusFornecedorResponse"));
