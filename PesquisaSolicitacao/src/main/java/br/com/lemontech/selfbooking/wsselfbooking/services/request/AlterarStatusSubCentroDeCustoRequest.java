/**
 * AlterarStatusSubCentroDeCustoRequest.java
 *
...
public class AlterarStatusSubCentroDeCustoRequest  implements java.io.Serializable {
    private boolean ativo;

    private br.com.lemontech.selfbooking.wsselfbooking.beans.SubCentroDeCustoRef subCentroDeCustoRef;

    public AlterarStatusSubCentroDeCustoRequest() {
    }
    ...
    /**
     * Gets the ativo value for this AlterarStatusSubCentroDeCustoRequest.
     * 
     * @return ativo
     */
    ...
    /**
     * Sets the ativo value for this AlterarStatusSubCentroDeCustoRequest.
     * 
     * @param ativo
     */
    ...
    /**
     * Gets the subCentroDeCustoRef value for this AlterarStatusSubCentroDeCustoRequest.
     * 
    ...
    /**
     * Sets the subCentroDeCustoRef value for this AlterarStatusSubCentroDeCustoRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AlterarStatusSubCentroDeCustoRequest)) return false;
        AlterarStatusSubCentroDeCustoRequest other = (AlterarStatusSubCentroDeCustoRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AlterarStatusSubCentroDeCustoRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/request", "alterarStatusSubCentroDeCustoRequest"));
