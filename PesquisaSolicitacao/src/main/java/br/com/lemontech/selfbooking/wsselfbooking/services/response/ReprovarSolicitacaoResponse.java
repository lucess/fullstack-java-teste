/**
 * ReprovarSolicitacaoResponse.java
 *
...
public class ReprovarSolicitacaoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public ReprovarSolicitacaoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this ReprovarSolicitacaoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this ReprovarSolicitacaoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReprovarSolicitacaoResponse)) return false;
        ReprovarSolicitacaoResponse other = (ReprovarSolicitacaoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReprovarSolicitacaoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "reprovarSolicitacaoResponse"));
