/**
 * AlterarStatusContaContabilResponse.java
 *
...
public class AlterarStatusContaContabilResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public AlterarStatusContaContabilResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this AlterarStatusContaContabilResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this AlterarStatusContaContabilResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AlterarStatusContaContabilResponse)) return false;
        AlterarStatusContaContabilResponse other = (AlterarStatusContaContabilResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AlterarStatusContaContabilResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "alterarStatusContaContabilResponse"));
