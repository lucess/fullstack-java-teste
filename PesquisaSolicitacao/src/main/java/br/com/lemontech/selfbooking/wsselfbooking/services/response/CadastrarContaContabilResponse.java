/**
 * CadastrarContaContabilResponse.java
 *
...
public class CadastrarContaContabilResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public CadastrarContaContabilResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this CadastrarContaContabilResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this CadastrarContaContabilResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CadastrarContaContabilResponse)) return false;
        CadastrarContaContabilResponse other = (CadastrarContaContabilResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CadastrarContaContabilResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "cadastrarContaContabilResponse"));
