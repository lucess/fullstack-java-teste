/**
 * AlterarStatusSubCentroDeCustoResponse.java
 *
...
public class AlterarStatusSubCentroDeCustoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public AlterarStatusSubCentroDeCustoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this AlterarStatusSubCentroDeCustoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this AlterarStatusSubCentroDeCustoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AlterarStatusSubCentroDeCustoResponse)) return false;
        AlterarStatusSubCentroDeCustoResponse other = (AlterarStatusSubCentroDeCustoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AlterarStatusSubCentroDeCustoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "alterarStatusSubCentroDeCustoResponse"));
