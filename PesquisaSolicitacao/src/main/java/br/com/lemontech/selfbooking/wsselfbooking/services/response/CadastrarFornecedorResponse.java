/**
 * CadastrarFornecedorResponse.java
 *
...
public class CadastrarFornecedorResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public CadastrarFornecedorResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this CadastrarFornecedorResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this CadastrarFornecedorResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CadastrarFornecedorResponse)) return false;
        CadastrarFornecedorResponse other = (CadastrarFornecedorResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CadastrarFornecedorResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "cadastrarFornecedorResponse"));
