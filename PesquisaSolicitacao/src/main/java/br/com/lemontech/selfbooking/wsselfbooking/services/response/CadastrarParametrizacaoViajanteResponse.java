/**
 * CadastrarParametrizacaoViajanteResponse.java
 *
...
public class CadastrarParametrizacaoViajanteResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public CadastrarParametrizacaoViajanteResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this CadastrarParametrizacaoViajanteResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this CadastrarParametrizacaoViajanteResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CadastrarParametrizacaoViajanteResponse)) return false;
        CadastrarParametrizacaoViajanteResponse other = (CadastrarParametrizacaoViajanteResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CadastrarParametrizacaoViajanteResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "cadastrarParametrizacaoViajanteResponse"));
