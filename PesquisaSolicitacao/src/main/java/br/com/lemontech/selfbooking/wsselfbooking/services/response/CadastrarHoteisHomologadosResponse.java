/**
 * CadastrarHoteisHomologadosResponse.java
 *
...
public class CadastrarHoteisHomologadosResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public CadastrarHoteisHomologadosResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this CadastrarHoteisHomologadosResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this CadastrarHoteisHomologadosResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CadastrarHoteisHomologadosResponse)) return false;
        CadastrarHoteisHomologadosResponse other = (CadastrarHoteisHomologadosResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CadastrarHoteisHomologadosResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "cadastrarHoteisHomologadosResponse"));
