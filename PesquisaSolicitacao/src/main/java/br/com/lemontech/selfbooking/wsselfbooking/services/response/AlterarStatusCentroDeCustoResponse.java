/**
 * AlterarStatusCentroDeCustoResponse.java
 *
...
public class AlterarStatusCentroDeCustoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public AlterarStatusCentroDeCustoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this AlterarStatusCentroDeCustoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this AlterarStatusCentroDeCustoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AlterarStatusCentroDeCustoResponse)) return false;
        AlterarStatusCentroDeCustoResponse other = (AlterarStatusCentroDeCustoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AlterarStatusCentroDeCustoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "alterarStatusCentroDeCustoResponse"));
