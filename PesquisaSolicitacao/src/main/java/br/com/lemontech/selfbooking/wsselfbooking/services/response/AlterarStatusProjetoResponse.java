/**
 * AlterarStatusProjetoResponse.java
 *
...
public class AlterarStatusProjetoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public AlterarStatusProjetoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this AlterarStatusProjetoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this AlterarStatusProjetoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AlterarStatusProjetoResponse)) return false;
        AlterarStatusProjetoResponse other = (AlterarStatusProjetoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AlterarStatusProjetoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "alterarStatusProjetoResponse"));
