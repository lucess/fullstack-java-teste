/**
 * CadastrarRegionalResponse.java
 *
...
public class CadastrarRegionalResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public CadastrarRegionalResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this CadastrarRegionalResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this CadastrarRegionalResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CadastrarRegionalResponse)) return false;
        CadastrarRegionalResponse other = (CadastrarRegionalResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CadastrarRegionalResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "cadastrarRegionalResponse"));
