/**
 * AlterarStatusRegionalResponse.java
 *
...
public class AlterarStatusRegionalResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public AlterarStatusRegionalResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this AlterarStatusRegionalResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this AlterarStatusRegionalResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AlterarStatusRegionalResponse)) return false;
        AlterarStatusRegionalResponse other = (AlterarStatusRegionalResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AlterarStatusRegionalResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "alterarStatusRegionalResponse"));
