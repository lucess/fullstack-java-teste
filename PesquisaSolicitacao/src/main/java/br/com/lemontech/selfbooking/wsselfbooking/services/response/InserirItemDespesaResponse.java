/**
 * InserirItemDespesaResponse.java
 *
...
public class InserirItemDespesaResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public InserirItemDespesaResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this InserirItemDespesaResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this InserirItemDespesaResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InserirItemDespesaResponse)) return false;
        InserirItemDespesaResponse other = (InserirItemDespesaResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InserirItemDespesaResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "inserirItemDespesaResponse"));
