/**
 * InserirIdentificadorIntegracaoResponse.java
 *
...
public class InserirIdentificadorIntegracaoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public InserirIdentificadorIntegracaoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this InserirIdentificadorIntegracaoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this InserirIdentificadorIntegracaoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InserirIdentificadorIntegracaoResponse)) return false;
        InserirIdentificadorIntegracaoResponse other = (InserirIdentificadorIntegracaoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InserirIdentificadorIntegracaoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "inserirIdentificadorIntegracaoResponse"));
