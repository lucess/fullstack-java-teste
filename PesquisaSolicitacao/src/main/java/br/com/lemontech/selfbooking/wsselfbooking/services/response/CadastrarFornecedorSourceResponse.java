/**
 * CadastrarFornecedorSourceResponse.java
 *
...
public class CadastrarFornecedorSourceResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public CadastrarFornecedorSourceResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this CadastrarFornecedorSourceResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this CadastrarFornecedorSourceResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CadastrarFornecedorSourceResponse)) return false;
        CadastrarFornecedorSourceResponse other = (CadastrarFornecedorSourceResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CadastrarFornecedorSourceResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "cadastrarFornecedorSourceResponse"));
