...
public class AtrelarUsuariosResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public AtrelarUsuariosResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this AtrelarUsuariosResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this AtrelarUsuariosResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AtrelarUsuariosResponse)) return false;
        AtrelarUsuariosResponse other = (AtrelarUsuariosResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AtrelarUsuariosResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "atrelarUsuariosResponse"));
