/**
 * CadastrarTarifarioResponse.java
 *
...
public class CadastrarTarifarioResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public CadastrarTarifarioResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this CadastrarTarifarioResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this CadastrarTarifarioResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CadastrarTarifarioResponse)) return false;
        CadastrarTarifarioResponse other = (CadastrarTarifarioResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CadastrarTarifarioResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "cadastrarTarifarioResponse"));
