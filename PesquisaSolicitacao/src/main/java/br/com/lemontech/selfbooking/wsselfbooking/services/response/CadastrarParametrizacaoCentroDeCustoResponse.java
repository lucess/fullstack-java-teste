/**
 * CadastrarParametrizacaoCentroDeCustoResponse.java
 *
...
public class CadastrarParametrizacaoCentroDeCustoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public CadastrarParametrizacaoCentroDeCustoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this CadastrarParametrizacaoCentroDeCustoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this CadastrarParametrizacaoCentroDeCustoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CadastrarParametrizacaoCentroDeCustoResponse)) return false;
        CadastrarParametrizacaoCentroDeCustoResponse other = (CadastrarParametrizacaoCentroDeCustoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CadastrarParametrizacaoCentroDeCustoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "cadastrarParametrizacaoCentroDeCustoResponse"));
